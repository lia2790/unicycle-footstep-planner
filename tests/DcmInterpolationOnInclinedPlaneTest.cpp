...
typedef struct
{
    ...
    // inclined plane angle RAD
    double inclPlaneAngle = iDynTree::deg2rad(10);
...
bool configureGenerator(UnicycleGenerator& generator, const Configuration &conf)
{
    ...
    iDynTree::assertTrue(dcmGenerator->setOmega(9.81*std::cos(conf.inclPlaneAngle)/conf.comHeight));
...
bool interpolationTest()
{
    ...
    initVelocity.zero();
    initPosition(0) = initPosition(0)*std::cos(conf.inclPlaneAngle);
    finalPosition(0) = initPosition(0) + 0.5;
    finalPosition(1) = initPosition(1) + 0;
    finalVelocity.zero();
    std::cout<< "initialPosition: "<< initPosition(0)  << ' ' << initPosition(1) << std::endl;
    std::cout<< "finalPosition: "  << finalPosition(0) << ' ' << finalPosition(1) << std::endl;

    // set the init time of the trajectory
    double initTime = 0;

    // add desired initial and final position for the unicycle
    ...
    std::string pLFileName("pL1OIP.txt");
    std::string pRFileName("pR1OIP.txt");
    std::string footstepsLFileName("footstepsL1OIP.txt");
    std::string footstepsRFileName("footstepsR1OIP.txt");
    std::string heightFileName("height1OIP.txt");
    std::string heightAccFileName("heightAcc1OIP.txt");
    std::string DCMPosFileName("DCMPos1OIP.txt");
    std::string DCMVelFileName("DCMVel1OIP.txt");
    std::string mergePointsFileName("mergePoints1OIP.txt");
    std::string lFootWeightFileName("leftFootWeight1OIP.txt");
    std::string rFootWeightFileName("rightFootWeight1OIP.txt");
    ...
    // save data
    footstepsLFileName = "footstepsL2OIP.txt";
    footstepsRFileName = "footstepsR2OIP.txt";
    DCMPosFileName = "DCMPos2OIP.txt";
    DCMVelFileName = "DCMVel2OIP.txt";
    mergePointsFileName = "mergePoints2OIP.txt";
    lFootWeightFileName = "leftFootWeight2OIP.txt";
    rFootWeightFileName = "rightFootWeight2OIP.txt";
    ...
    // save data
    pLFileName = "pL3OIP.txt";
    pRFileName = "pR3OIP.txt";
    footstepsLFileName = "footstepsL3OIP.txt";
    footstepsRFileName = "footstepsR3OIP.txt";
    heightFileName = "height3OIP.txt";
    heightAccFileName = "heightAcc3OIP.txt";
    DCMPosFileName = "DCMPos3OIP.txt";
    DCMVelFileName = "DCMVel3OIP.txt";
    mergePointsFileName = "mergePoints3OIP.txt";
    lFootWeightFileName = "leftFootWeight3OIP.txt";
    rFootWeightFileName = "rightFootWeight3OIP.txt";
